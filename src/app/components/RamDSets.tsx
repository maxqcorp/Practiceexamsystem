      ...
      <div className="max-w-6xl mx-auto">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will clear all your answers and progress for all 15-question sets. This action cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">RamD Practice Mode</h1>
          </div>
          <p className="text-lg text-gray-600 mb-2">
            {totalQuestions} questions across {examSetsRamD.length} practice sets (15 questions each)
          </p>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                          ...
                          <AlertDialogAction
                            onClick={async () => {
                              await clearWrongAnswersForSet(set.id + 2000, set.questions);
                              setRefreshKey(prev => prev + 1);
                            }}
        ...
        <div className="mt-12 bg-white rounded-lg p-6 shadow-md">
          <h2 className="text-xl font-semibold mb-3 text-gray-900">About RamD Practice Mode</h2>
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">•</span>
              <span>Each set contains 15 questions for focused, manageable practice sessions</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">•</span>
              <span>Perfect balance between quick review and comprehensive learning</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold">•</span>
