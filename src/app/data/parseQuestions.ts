import { Question, ExamSet } from './questions';

export function parseQuestionsFromMarkdown(markdown: string): Question[] {
...
export function createExamSets(allQuestions: Question[]): ExamSet[] {
  ...
  for (let i = 0; i < allQuestions.length; i += questionsPerSet) {
    ...
    examSets.push({
      id: setNumber,
      title: `Practice Exam Set ${setNumber}`,
